...
// const PDFdownload = ({ bookName, content }) => {
...
//             className={`w-[185px] h-[50px] lg:w-[190px] py-2 px-3 sm:py-2 sm:px-2 mb-6 ${isGenerating ? ' cursor-not-allowed' : ''
//                 } rounded-lg shadow transition duration-300 ease-in-out  w-full sm:w-[180px] py-[10px] px-[16px] mb-[24px] bg-white r border border-gray-300 justify-center items-center inline-flex`}
//         >
...
const PDFdownload = ({ bookName, content, onDownload }) => {
    ...
    return (
        <button
            onClick={handleClick}
            disabled={isGenerating}
            className={`w-[185px] h-[50px] lg:w-[190px] py-2 px-3 sm:py-2 sm:px-2 mb-6 ${isGenerating ? 'cursor-not-allowed' : ''} rounded-lg shadow transition duration-300 ease-in-out w-full sm:w-[180px] py-[10px] px-[16px] mb-[24px] bg-white border border-gray-300 justify-center items-center inline-flex`}
        >
            <img src={pdf} alt="pdf" className="w-6 h-6" />
            <span className="mx-2 text-sm sm:text-base font-medium">
                {isGenerating ? 'Generating PDF...' : 'Download PDF'}
