...
// return (
//   <div
//     className={`py-[32px] ${isOpen ? "px-[32px]" : ""} flex flex-col ${isOpen ? "" : "items-center"
//       }`}
//   >
//     {/* Admin-only links */}
//     {isAdmin ? (
...
//         <Link
//           to="/create"
//           className={`flex items-center justify-start menu hover:bg-gray-50 rounded-lg h-12 p-2 ${isOpen ? "w-[230px]" : "w-10"
//             }`}
//         >
//           <img className="w-6 h-6 my-[12px]" src={createpost} alt="Create Post" />
...
//         <Link
//           to="/"
//           className={`flex items-center justify-start menu rounded-lg h-12 p-2 ${isOpen ? "w-[230px]" : "w-10"
...
//         <Link
//           to="/request"
//           className={`flex items-center menu rounded-lg h-12 p-2 ${isOpen ? "w-[230px]" : "w-10"
...
//                 <div className="text-violet-700 text-[10px] font-semibold font-['Inter']">NEW</div>
//               </div>
//             </span>
//           )}
//         </Link>
...
//           <div className={`h-px linecolor my-[12px] ${isOpen ? "w-[100px]" : "w-10"}`}></div>
//         </div>

//         <Link
//           to="/"
//           className={`flex items-center hover:bg-gray-50 rounded-lg h-12 p-2 ${isOpen ? "w-[230px]" : "w-10"}`}
//         >
...
//                 <div className="text-amber-700 text-[10px] font-semibold font-['Inter']">SOON</div>
//               </div>
//             </span>
//           )}
//         </Link>
      ...
      {isAdmin ? (
        ...
        <>
          ...
          {currentUser ? (
            ...
            >
              <img className="w-6 h-6 my-[12px]" src={profile} alt="Logout" />
            ...
            <Link
              ...
              className={`flex items-center hover:bg-gray-50 rounded-lg h-12 p-2 ${
                isOpen ? "w-[230px]" : "w-10"
              } ${isActive("/login") ? "bg-white border border-gray-300" : ""}`}
            >
              <img className="w-6 h-6 my-[12px]" src={profile} alt="Login" />
